...
contract RelayWatchtowerTest is Test {
    ...
    function test_Register() public {
        ...
        RelayWatchtower.Watchtower memory info = watchtower.getWatchtowerInfo(
            wt1
        );
        ...
        assertEq(
            uint8(info.status),
            uint8(RelayWatchtower.WatchtowerStatus.ACTIVE)
        );
    }
    ...
    function test_Register_EmitsEvent() public {
        ...
        emit RelayWatchtower.WatchtowerRegistered(wt1, 2 ether);
    ...
    function test_Register_RevertInsufficientStake() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                RelayWatchtower.InsufficientStake.selector,
                0.5 ether,
                1 ether
            )
        );
    ...
    function test_Register_RevertAlreadyRegistered() public {
        ...
        watchtower.register{value: 1 ether}();
        vm.prank(wt1);
        vm.expectRevert(RelayWatchtower.AlreadyRegistered.selector);
        watchtower.register{value: 1 ether}();
    }
    ...
    function test_AddStake_RevertNotRegistered() public {
        vm.prank(outsider);
        vm.expectRevert(RelayWatchtower.NotRegistered.selector);
    ...
    function test_RequestExit() public {
        ...
        assertEq(
            uint8(info.status),
            uint8(RelayWatchtower.WatchtowerStatus.EXITING)
        );
    }
    ...
    function test_CompleteExit_RevertBeforeDelay() public {
        ...
        watchtower.requestExit();
        vm.prank(wt1);
        vm.expectRevert(RelayWatchtower.ExitDelayNotPassed.selector);
        watchtower.completeExit();
    }
    ...
    function test_CompleteExit_RevertNotExiting() public {
        ...
        watchtower.register{value: 1 ether}();
        vm.prank(wt1);
        vm.expectRevert(RelayWatchtower.ExitNotRequested.selector);
        watchtower.completeExit();
    }
    ...
    function test_SubmitReport() public {
        ...
        bytes32 reportId = watchtower.submitReport(
            RelayWatchtower.ReportType.INVALID_PROOF,
            keccak256("suspicious"),
            hex"dead"
        );
        assertTrue(reportId != bytes32(0));
        RelayWatchtower.AnomalyReport memory report = watchtower.getReport(
            reportId
        );
        ...
        assertEq(
            uint8(report.status),
            uint8(RelayWatchtower.ReportStatus.PENDING)
        );
    }
    ...
    function test_SubmitReport_IncrementsReportCount() public {
        ...
        vm.prank(wt1);
        watchtower.submitReport(
            RelayWatchtower.ReportType.STATE_MISMATCH,
            bytes32(uint256(1)),
            hex"01"
        );
        vm.prank(wt1);
        watchtower.submitReport(
            RelayWatchtower.ReportType.DOUBLE_SPEND,
            bytes32(uint256(2)),
            hex"02"
        );
    ...
    function test_VoteOnReport_Reject() public {
        ...
        vm.prank(wt1);
        bytes32 reportId = watchtower.submitReport(
            RelayWatchtower.ReportType.BRIDGE_DELAY,
            keccak256("target"),
            hex"cafe"
        );
        vm.prank(wt2);
    ...
    function test_VoteOnReport_RevertAlreadyVoted() public {
        ...
        vm.prank(wt2);
        vm.expectRevert(RelayWatchtower.AlreadyVoted.selector);
        watchtower.voteOnReport(reportId, true);
    }
    ...
    function test_VoteOnReport_RevertNotFound() public {
        _registerWatchtowers(1);
        vm.prank(wt1);
        vm.expectRevert(RelayWatchtower.ReportNotFound.selector);
    ...
    function test_ReportFinalization_Confirmed() public {
        ...
        assertEq(
            uint8(report.status),
            uint8(RelayWatchtower.ReportStatus.CONFIRMED)
        );
    }
    ...
    function test_ReportFinalization_Rejected() public {
        ...
        vm.prank(wt1);
        bytes32 reportId = watchtower.submitReport(
            RelayWatchtower.ReportType.SUSPICIOUS_PATTERN,
            keccak256("maybe_bad"),
            hex"0001"
        );
        ...
        assertEq(
            uint8(report.status),
            uint8(RelayWatchtower.ReportStatus.REJECTED)
        );
    }

    function test_FalseReportSlashes() public {
        _registerWatchtowers(4);
        RelayWatchtower.Watchtower memory infoBefore = watchtower
        ...
        RelayWatchtower.Watchtower memory infoAfter = watchtower
            .getWatchtowerInfo(wt1);
    ...
    function test_AttestProof_RevertAlreadyAttested() public {
        ...
        watchtower.attestProof(proofHash, true);
        vm.prank(wt1);
        vm.expectRevert(RelayWatchtower.AlreadyAttested.selector);
        watchtower.attestProof(proofHash, true);
    }
    ...
    function test_Slash_BelowMinStake_StatusSlashed() public {
        ...
        assertEq(
            uint8(info.status),
            uint8(RelayWatchtower.WatchtowerStatus.SLASHED)
        );
        assertEq(watchtower.getActiveWatchtowerCount(), 0);
    }
    ...
    function test_ClaimRewards_RevertNoRewards() public {
        ...
        watchtower.register{value: 1 ether}();
        vm.prank(wt1);
        vm.expectRevert(RelayWatchtower.NoRewardsAvailable.selector);
