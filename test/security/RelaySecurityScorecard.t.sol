...
import {RelaySecurityScorecard} from "../../contracts/security/RelaySecurityScorecard.sol";
import {IAccessControl} from "@openzeppelin/contracts/access/IAccessControl.sol";

contract RelaySecurityScorecardTest is Test {
    ...
    function test_updateScore_setsAllComponents() public {
        ...
        RelaySecurityScorecard.SecurityScore memory score = scorecard.getScore(
            bridge1
        );
    ...
    function test_updateScore_emitsScoreUpdated() public {
        ...
        emit RelaySecurityScorecard.ScoreUpdated(bridge1, 50);
    ...
    function test_setMinimumSafeScore_emitsEvent() public {
        ...
        emit RelaySecurityScorecard.MinimumSafeScoreUpdated(50);
        scorecard.setMinimumSafeScore(50);
    }
