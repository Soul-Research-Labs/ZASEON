...
contract RelayProofValidatorTest is Test {
    RelayProofValidator public validator;
    ...
    function setUp() public {
        ...
        validator = new RelayProofValidator(admin);
    ...
    function test_SubmitProof() public {
        ...
        (
            ...
            ,
            ,
            RelayProofValidator.ProofStatus status,
            uint256 value,
        ...
        assertEq(
            uint8(status),
            uint8(RelayProofValidator.ProofStatus.SUBMITTED)
        );
    ...
    function test_SubmitProof_EventEmitted() public {
        ...
        emit RelayProofValidator.ProofSubmitted(
            hash,
            operator,
            1 ether,
            block.number + 300,
    ...
    function test_SubmitProof_RevertDuplicate() public {
        ...
        vm.prank(operator);
        vm.expectRevert(RelayProofValidator.ProofAlreadyExists.selector);
        validator.submitProof(hash, keccak256("c"), 1 ether, keccak256("ETH"));
    }
    ...
    function test_SubmitProof_RevertExceedsPerTxCap() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                RelayProofValidator.ExceedsWithdrawalCap.selector,
                200 ether,
                100 ether
            )
        );
    ...
    function test_ConfirmProof_RevertNotWatchtower() public {
        ...
        vm.prank(address(0xDEAD));
        vm.expectRevert(RelayProofValidator.NotWatchtower.selector);
        validator.confirmProof(hash);
    }
    ...
    function test_ConfirmProof_RevertAlreadyConfirmed() public {
        ...
        vm.prank(watchtower1);
        vm.expectRevert(RelayProofValidator.AlreadyConfirmed.selector);
        validator.confirmProof(hash);
    }
    ...
    function test_FinalizeProof() public {
        ...
        RelayProofValidator.ProofStatus status = validator.getProofStatus(
            hash
        );
        assertEq(
            uint8(status),
            uint8(RelayProofValidator.ProofStatus.FINALIZED)
        );
    ...
    function test_FinalizeProof_RevertChallengePeriodActive() public {
        ...
        vm.expectRevert(RelayProofValidator.ChallengePeriodActive.selector);
    ...
    function test_FinalizeProof_RevertInsufficientConfirmations() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                RelayProofValidator.InsufficientConfirmations.selector,
                1,
                2
            )
        );
    ...
    function test_ProofExpiry() public {
        ...
        assertEq(
            uint8(status),
            uint8(RelayProofValidator.ProofStatus.EXPIRED)
        );
    }
    ...
    function test_ChallengeProof() public {
        ...
        assertEq(
            uint8(status),
            uint8(RelayProofValidator.ProofStatus.CHALLENGED)
        );
    ...
    function test_ChallengeProof_RevertAfterDeadline() public {
        ...
        vm.prank(challenger);
        vm.expectRevert(RelayProofValidator.ChallengePeriodEnded.selector);
        validator.challengeProof(hash, hex"deadbeef");
    }
    ...
    function test_ResolveChallenge_Upheld() public {
        ...
        assertEq(
            uint8(status),
            uint8(RelayProofValidator.ProofStatus.REJECTED)
        );
    ...
    function test_AddWatchtower_RevertAlreadyExists() public {
        vm.expectRevert(RelayProofValidator.AlreadyWatchtower.selector);
        validator.addWatchtower(watchtower1);
    }
    ...
    function test_RemoveWatchtower_RevertLastOne() public {
        ...
        vm.expectRevert(
            RelayProofValidator.CannotRemoveLastWatchtower.selector
        );
    ...
    function test_SetMaxProofBlocks_RevertInvalid() public {
        vm.expectRevert(RelayProofValidator.InvalidBlocks.selector);
    ...
    function test_SetChallengePeriod_RevertTooShort() public {
        vm.expectRevert(RelayProofValidator.PeriodTooShort.selector);
    ...
    function test_SetWithdrawalCaps_RevertInvalid() public {
        vm.expectRevert(RelayProofValidator.InvalidCapConfiguration.selector);
        validator.setWithdrawalCaps(200 ether, 100 ether, 12 hours, true);

        vm.expectRevert(RelayProofValidator.EpochTooShort.selector);
    ...
    function test_SetRequiredConfirmations_RevertInvalid() public {
        vm.expectRevert(RelayProofValidator.InvalidCount.selector);
    ...
    function test_GetProofStatus_None() public view {
        assertEq(
            ...
            uint8(RelayProofValidator.ProofStatus.NONE)
        );
    }
