...
contract BridgeCircuitBreakerTest is Test {
    BridgeCircuitBreaker public breaker;
    ...
    function setUp() public {
        admin = address(this);
        breaker = new BridgeCircuitBreaker(admin);
    ...
    function test_guardianCanReportAnomaly() public {
        ...
        breaker.reportAnomaly(
            BridgeCircuitBreaker.AnomalyType.EXTERNAL_TRIGGER,
            50,
            keccak256("test")
        );
