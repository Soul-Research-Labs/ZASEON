...
contract RelayFraudProofTest is Test {
    RelayFraudProof public fraudProof;
    ...
    function setUp() public {
        ...
        fraudProof = new RelayFraudProof(address(verifier), admin);
    ...
    function test_AutomatedFraudResolution() public {
        ...
        OptimisticRelayVerifier.PendingTransfer memory transfer = verifier
    ...
    function test_EmitsFraudVerified() public {
        ...
        emit RelayFraudProof.FraudVerified(transferId);
    ...
    function test_EmitsFraudProofSubmitted() public {
        ...
        emit RelayFraudProof.FraudProofSubmitted(transferId, address(this));
        fraudProof.submitFraudProof(transferId, PROOF, bytes("FRAUD_EV"));
    }
