...
/**
 * @title CompletionInvariantsTest
 * @notice Invariant / fuzz tests for InstantCompletionGuarantee and InstantRelayerRewards.
 ...
 */
contract CompletionInvariantsTest is Test {
    ...
    function setUp() public {
        ...
        guarantee.grantRole(guarantee.COMPLETION_ROLE(), admin);
        vm.stopPrank();
    }
    ...
    // =========================================================================
    // FUZZ: Guarantee Lifecycle – Completion Returns Bond
    // =========================================================================
    ...
    function testFuzz_solverStakeMinimum(uint256 stake) public {
        ...
        if (stake < 1 ether) {
            ...
            // Should succeed
            intentLayer.registerSolver{value: stake}();
            IIntentCompletionLayer.Solver memory s = intentLayer.getSolver(
                newSolver
            );
