...
contract SoulComplianceV2Test is Test {
    ...
    function test_authorizeProvider_revertsZeroAddress() public {
        vm.prank(owner);
        vm.expectRevert(SoulComplianceV2.ZeroAddress.selector);
    ...
    function test_verifyKYC_happyPath() public {
        ...
        compliance.verifyKYC(
            user1,
            SoulComplianceV2.KYCTier.Standard,
    ...
    function test_verifyKYC_revertsNonProvider() public {
        vm.prank(nobody);
        vm.expectRevert(SoulComplianceV2.NotAuthorizedProvider.selector);
        compliance.verifyKYC(
            user1,
    ...
    function test_verifyKYC_revertsRestrictedJurisdiction() public {
        ...
        vm.prank(provider);
        vm.expectRevert(SoulComplianceV2.RestrictedJurisdiction.selector);
        compliance.verifyKYC(
            user1,
            SoulComplianceV2.KYCTier.Basic,
            bytes32(uint256(1)),
    ...
    function test_verifyKYC_revertsSanctionedAddress() public {
        ...
        vm.prank(provider);
        vm.expectRevert(SoulComplianceV2.AddressIsSanctioned.selector);
        compliance.verifyKYC(
            user1,
            SoulComplianceV2.KYCTier.Basic,
            bytes32(uint256(1)),
    ...
    function test_meetsKYCTier() public {
        ...
        compliance.verifyKYC(
            user1,
            SoulComplianceV2.KYCTier.Enhanced,
            bytes32(uint256(1)),
            bytes2("US")
        );

        assertTrue(
            compliance.meetsKYCTier(user1, SoulComplianceV2.KYCTier.Basic)
        );
        assertTrue(
            compliance.meetsKYCTier(user1, SoulComplianceV2.KYCTier.Standard)
        );
        assertTrue(
            compliance.meetsKYCTier(user1, SoulComplianceV2.KYCTier.Enhanced)
        );
        assertFalse(
            compliance.meetsKYCTier(
                user1,
                SoulComplianceV2.KYCTier.Institutional
            )
        );
    }
    ...
    function test_isKYCValid_insufficientTier() public {
        vm.prank(owner);
        compliance.setMinRequiredTier(SoulComplianceV2.KYCTier.Enhanced);
    ...
    function test_recordAudit_revertsNonAuditor() public {
        vm.prank(nobody);
        vm.expectRevert(SoulComplianceV2.NotAuthorizedAuditor.selector);
    ...
    function test_setMinRequiredTier() public {
        vm.prank(owner);
        compliance.setMinRequiredTier(SoulComplianceV2.KYCTier.Institutional);
    ...
    function test_setKYCValidityDuration_revertsTooShort() public {
        vm.prank(owner);
        vm.expectRevert(SoulComplianceV2.DurationTooShort.selector);
        compliance.setKYCValidityDuration(12 hours);
    }

    function test_setKYCValidityDuration_revertsTooLong() public {
        vm.prank(owner);
        vm.expectRevert(SoulComplianceV2.DurationTooLong.selector);
