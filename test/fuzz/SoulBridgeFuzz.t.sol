...
/**
 * @title SoulBridgeFuzz
 * @notice Fuzz tests for all Soul bridge adapters and cross-chain messaging
 * @dev Tests LayerZero, Chainlink, Wormhole, StarkNet, Solana, Bitcoin bridges
 *
 * Run with: forge test --match-contract SoulBridgeFuzz --fuzz-runs 10000
 */
contract SoulBridgeFuzz is Test {
    /*//////////////////////////////////////////////////////////////
                            CONSTANTS
    //////////////////////////////////////////////////////////////*/
