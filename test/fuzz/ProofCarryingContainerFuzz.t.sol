...
contract ProofCarryingContainerFuzz is Test {
    ...
    function test_createContainer_happyPath() public {
        (bytes32 cId,) = _createDefaultContainer(bytes32(uint256(1)), bytes32(uint256(2)));
    ...
    function test_createContainer_emptyPayloadReverts() public {
        ...
        pc3.createContainer("", bytes32(uint256(1)), bytes32(uint256(2)), proofs, bytes32(0));
    }
    ...
    function test_createContainer_payloadTooLargeReverts() public {
        ...
        pc3.createContainer(bigPayload, bytes32(uint256(1)), bytes32(uint256(2)), proofs, bytes32(0));
    }
    ...
    function test_createContainer_zeroStateReverts() public {
        ...
        vm.prank(user1);
        vm.expectRevert(ProofCarryingContainer.InvalidContainerData.selector);
        pc3.createContainer("payload", bytes32(0), bytes32(uint256(2)), proofs, bytes32(0));
    }
    ...
    function test_createContainer_zeroNullifierReverts() public {
        ...
        vm.prank(user1);
        vm.expectRevert(ProofCarryingContainer.InvalidContainerData.selector);
        pc3.createContainer("payload", bytes32(uint256(1)), bytes32(0), proofs, bytes32(0));
    }

    function test_createContainer_proofTooSmallReverts() public {
        bytes memory smallProof = new bytes(128); // < MIN_PROOF_SIZE
        ProofCarryingContainer.ProofBundle memory proofs = ProofCarryingContainer.ProofBundle({
        ...
        proofs.proofHash = keccak256(abi.encode(proofs.validityProof, proofs.policyProof, proofs.nullifierProof));
        ...
        pc3.createContainer("payload", bytes32(uint256(1)), bytes32(uint256(2)), proofs, bytes32(0));
    }
    ...
    function test_createContainer_unsupportedPolicyReverts() public {
        ...
        vm.prank(user1);
        vm.expectRevert(abi.encodeWithSelector(ProofCarryingContainer.UnsupportedPolicy.selector, unknownPolicy));
        pc3.createContainer("payload", bytes32(uint256(1)), bytes32(uint256(2)), proofs, unknownPolicy);
    }
    ...
    function test_createContainer_withSupportedPolicy() public {
        ...
        ProofCarryingContainer.ProofBundle memory proofs = _makeProofBundle();
        vm.prank(user1);
        pc3.createContainer("payload", bytes32(uint256(1)), bytes32(uint256(2)), proofs, policyHash);
    }
    ...
    function test_createContainer_consumedNullifierReverts() public {
        ...
        ProofCarryingContainer.ProofBundle memory proofs = _makeProofBundle();
        vm.prank(user1);
        vm.expectRevert(abi.encodeWithSelector(ProofCarryingContainer.NullifierAlreadyConsumed.selector, nullifier));
        pc3.createContainer("payload2", bytes32(uint256(3)), nullifier, proofs, bytes32(0));
    }
    ...
    function test_createContainer_duplicateIdReverts() public {
        ...
        vm.prank(user1);
        vm.expectRevert(abi.encodeWithSelector(ProofCarryingContainer.ContainerAlreadyExists.selector, cId));
    ...
    function test_verifyContainer_valid() public {
        ...
        ProofCarryingContainer.VerificationResult memory r = pc3.verifyContainer(cId);
    ...
    function test_verifyContainer_notFound() public {
        ProofCarryingContainer.VerificationResult memory r = pc3.verifyContainer(bytes32(uint256(999)));
    ...
    function test_consumeContainer_happyPath() public {
        (bytes32 cId, bytes32 nullifier) = _createDefaultContainer(bytes32(uint256(1)), bytes32(uint256(2)));
    ...
    function test_consumeContainer_notFoundReverts() public {
        ...
        vm.prank(verifier);
        vm.expectRevert(abi.encodeWithSelector(ProofCarryingContainer.ContainerNotFound.selector, fake));
    ...
    function test_consumeContainer_alreadyConsumedReverts() public {
        ...
        vm.prank(verifier);
        vm.expectRevert(abi.encodeWithSelector(ProofCarryingContainer.ContainerAlreadyConsumed.selector, cId));
        pc3.consumeContainer(cId);
    }

    function testFuzz_consumeContainer_unauthorizedReverts(address caller) public {
    ...
    function test_importContainer_consumedNullifierReverts() public {
        ...
        (bytes32 cId,) = _createDefaultContainer(bytes32(uint256(0xA)), nullifier);
        vm.prank(verifier);
        pc3.consumeContainer(cId);
    ...
    function test_exportContainer_notFoundReverts() public {
        vm.expectRevert(abi.encodeWithSelector(ProofCarryingContainer.ContainerNotFound.selector, bytes32(uint256(999))));
    ...
    function test_batchVerifyContainers() public {
        (bytes32 cId1,) = _createDefaultContainer(bytes32(uint256(1)), bytes32(uint256(2)));
        (bytes32 cId2,) = _createDefaultContainer(bytes32(uint256(3)), bytes32(uint256(4)));

        bytes32[] memory ids = new bytes32[](2);
        ids[0] = cId1;
        ids[1] = cId2;

        ProofCarryingContainer.VerificationResult[] memory results = pc3.batchVerifyContainers(ids);
    ...
    function testFuzz_containerIdDeterministic(bytes32 state, bytes32 nullifier) public {
        vm.assume(state != bytes32(0) && nullifier != bytes32(0));
        bytes32 expected = keccak256(abi.encodePacked(state, nullifier, uint64(block.chainid)));
    ...
    function testFuzz_proofBundleIntegrity(
        ...
        bytes memory vProof = abi.encodePacked(seed1, new bytes(pc3.MIN_PROOF_SIZE()));
        bytes memory pProof = abi.encodePacked(seed2, new bytes(pc3.MIN_PROOF_SIZE()));
        bytes memory nProof = abi.encodePacked(seed3, new bytes(pc3.MIN_PROOF_SIZE()));
        ...
        pc3.createContainer(
            "payload",
            bytes32(uint256(uint256(keccak256(abi.encodePacked(seed1, seed2))) % type(uint256).max) + 1),
            bytes32(uint256(uint256(keccak256(abi.encodePacked(seed2, seed3))) % type(uint256).max) + 1),
            proofs,
            bytes32(0)
        );
    }
    ...
    function _makeProofBundle() internal view returns (ProofCarryingContainer.ProofBundle memory) {
        bytes memory vProof = new bytes(pc3.MIN_PROOF_SIZE());
        bytes memory pProof = new bytes(pc3.MIN_PROOF_SIZE());
        bytes memory nProof = new bytes(pc3.MIN_PROOF_SIZE());
        bytes32 hash = keccak256(abi.encode(vProof, pProof, nProof));

        return ProofCarryingContainer.ProofBundle({
            validityProof: vProof,
            policyProof: pProof,
            nullifierProof: nProof,
            proofHash: hash,
    ...
    function _createDefaultContainer(
        ...
        ProofCarryingContainer.ProofBundle memory proofs = _makeProofBundle();
        vm.prank(user1);
        cId = pc3.createContainer("default_payload", state, nullifier, proofs, bytes32(0));
    ...
    function _computeContainerId(
        ...
        return keccak256(abi.encodePacked(state, nullifier, uint64(block.chainid)));
    }
}
