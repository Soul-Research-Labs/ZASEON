...
/**
 * @title SoulInvariantTests
 * @notice Stateful invariant tests for Soul Network protocol properties
 * @dev Tests cross-contract interactions and global protocol invariants
 *
 * Run with: forge test --match-contract SoulInvariantTests --fuzz-runs 1000
 */
contract SoulInvariantTests is StdInvariant, Test {
    SoulNetworkHandler public handler;

    function setUp() public {
        handler = new SoulNetworkHandler();
...
/**
 * @title SoulNetworkHandler
 * @notice Handler contract for stateful invariant testing
 */
contract SoulNetworkHandler is Test {
    /*//////////////////////////////////////////////////////////////
                            STATE
    //////////////////////////////////////////////////////////////*/
