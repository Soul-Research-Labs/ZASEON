...
import "../../contracts/governance/SoulGovernor.sol";
...
contract MockVotesToken is ERC20, ERC20Permit, ERC20Votes {
    constructor()
        ERC20("Soul Governance Token", "SOUL")
        ERC20Permit("Soul Governance Token")
    {}
...
contract SoulGovernorTest is Test {
    ...
    function setUp() public {
        ...
        timelock = new SoulUpgradeTimelock(
            1 days, // minDelay
            proposers,
            executors,
            admin
