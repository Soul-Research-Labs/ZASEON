...
import "../../contracts/experimental/verifiers/SoulNewZKVerifiers.sol";
...
contract SoulNewZKVerifiersTest is Test {
    SoulSP1Verifier public sp1;
    SoulPlonky3Verifier public plonky3;
    SoulJoltVerifier public jolt;
    SoulBiniusVerifier public binius;
    ...
    function test_sp1_verify() public {
        ...
        SoulSP1Verifier.SP1Proof memory proof = SoulSP1Verifier.SP1Proof({
            vkeyHash: VKEY,
    ...
    function test_jolt_verify() public {
        ...
        SoulJoltVerifier.JoltProof memory proof = SoulJoltVerifier.JoltProof({
