...
contract Soulv2OrchestratorUpgradeableTest is Test {
    Soulv2OrchestratorUpgradeable orch;
    ...
    function setUp() public {
        ...
        orch = Soulv2OrchestratorUpgradeable(address(proxy));
    ...
    function test_upgrade_revertsNotUpgrader() public {
        Soulv2OrchestratorUpgradeable newImpl = new Soulv2OrchestratorUpgradeable();
        vm.prank(user1);
        vm.expectRevert();
