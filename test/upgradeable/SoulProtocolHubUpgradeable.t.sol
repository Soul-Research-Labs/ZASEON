...
/**
 * @title SoulProtocolHubUpgradeable Test
 ...
 */
contract SoulProtocolHubUpgradeableTest is Test {
    SoulProtocolHubUpgradeable public hub;
    SoulProtocolHubUpgradeable public implementation;
    ...
    function setUp() public {
        ...
        implementation = new SoulProtocolHubUpgradeable();

        // Encode initializer
        bytes memory initData = abi.encodeCall(
            SoulProtocolHubUpgradeable.initialize,
            (admin)
        );

        // Deploy proxy
        proxy = new ERC1967Proxy(address(implementation), initData);
        hub = SoulProtocolHubUpgradeable(address(proxy));
    ...
    function test_upgradeByUpgrader() public {
        SoulProtocolHubUpgradeable newImpl = new SoulProtocolHubUpgradeable();
