...
async function main() {
    console.log("\n" + "=".repeat(80));
    console.log("PIL v2 MULTI-CHAIN DEPLOYMENT");
    ...
    try {
        ...
        // 8. Deploy PILv2Orchestrator
        console.log("8️⃣  Deploying PILv2Orchestrator...");
        const PILv2Orchestrator = await ethers.getContractFactory("PILv2Orchestrator");
        const orchestrator = await PILv2Orchestrator.deploy(
        ...
        console.log(`   ✅ PILv2Orchestrator: ${deployed.contracts.orchestrator}`);
        ...
        // 9. Deploy PILTimelock
        console.log("9️⃣  Deploying PILTimelock...");
        const PILTimelock = await ethers.getContractFactory("PILTimelock");
        const timelock = await PILTimelock.deploy(
        ...
        console.log(`   ✅ PILTimelock: ${deployed.contracts.timelock}`);
