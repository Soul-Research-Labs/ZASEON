...
library FHEOperations {
    ...
    function add(
        ...
        return
            euint256(
                keccak256(abi.encodePacked(a.ciphertext, b.ciphertext, "add"))
            );
    }
    ...
    function sub(
        ...
        return
            euint256(
                keccak256(abi.encodePacked(a.ciphertext, b.ciphertext, "sub"))
            );
    }
    ...
    function mul(
        ...
        return
            euint256(
                keccak256(abi.encodePacked(a.ciphertext, b.ciphertext, "mul"))
            );
    }
    ...
    function lt(
        euint256 memory a,
        euint256 memory b
    ) internal pure returns (ebool memory) {
        return
            ebool(
                keccak256(abi.encodePacked(a.ciphertext, b.ciphertext, "lt"))
            );
    }
    ...
    function eq(
        ...
        return
            ebool(
                keccak256(abi.encodePacked(a.ciphertext, b.ciphertext, "eq"))
            );
    }
