...
/// @title MockCometBFTVerifier
/// @notice Mock verifier for Berachain CometBFT/Proof-of-Liquidity consensus in testing
/// @dev Simulates CometBFT consensus with PoL validator selection
contract MockCometBFTVerifier {
    ...
    /// @param votingPower Voting power (liquidity-backed) of the validator
    ...
    /// @notice Mock verify a CometBFT attestation
