...
/// @title MockMonadBFTVerifier
/// @notice Mock verifier for MonadBFT (HotStuff2) consensus verification in testing
/// @dev Simulates MonadBFT pipelined consensus with optimistic responsiveness
contract MockMonadBFTVerifier {
    ...
    /// @notice Mock verify a MonadBFT (HotStuff2) attestation
