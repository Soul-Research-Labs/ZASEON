...
/// @title MockTONLightClient
/// @notice Mock light client for TON Catchain BFT consensus verification in testing
/// @dev Simulates TON's Catchain BFT consensus and validator session management
contract MockTONLightClient {
    ...
    /// @notice Mock verify a Catchain BFT attestation
    ...
    /// @notice Advance the epoch (validator session rotation)
