 ...
 * @notice Governance token for the Soul Protocol ecosystem.
 ...
 *      - Timestamp-based clock (L2-compatible, matching SoulGovernor)
 *
 * TOKEN ECONOMICS:
 * ┌──────────────────────────────────────────────────────────────────┐
 * │  Max Supply:  1,000,000,000 SOUL (1 billion, 18 decimals)       │
    ...
    AccessControl
{
    ...
    constructor(
        ...
        ERC20("Soul Protocol", "SOUL")
        ERC20Capped(MAX_SUPPLY)
        ERC20Permit("Soul Protocol")
    {
