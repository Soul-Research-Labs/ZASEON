 ...
 * ══════════════════════════════════════════════════════════════════════════════════════════════════════
 *
 * The Soul Kernel is NOT an optimization - it is a CONSTITUTIONAL LAYER.
 *
 ...
 */
contract SoulKernelProof is AccessControl, ReentrancyGuard, Pausable {
    // ============================================
    // ROLES
    // ============================================
    ...
    /**
     * @notice Initialize the SoulKernelProof
     * @param _kernelVerifier Address of the kernel verifier contract
     */
