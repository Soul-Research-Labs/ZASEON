...
import {
  ...
  RelayerPacket,
  RelayerOptions,
} from "../src/client/SoulSDK";
import { SoulConfig } from "../src/utils/crypto";
...
describe("ProverModule", () => {
  ...
  describe("generateProof()", () => {
    ...
    it("should throw SoulError when circuit is missing", async () => {
      const prover = new ProverModule(PROVER_URL);
      try {
...
// ============================================================
// SoulSDK (integration of crypto + prover + relayer)
// ============================================================
...
describe("SoulSDK", () => {
  ...
  describe("constructor", () => {
    it("should instantiate without error", () => {
      ...
      expect(sdk).to.be.instanceOf(SoulSDK);
    });
  });
